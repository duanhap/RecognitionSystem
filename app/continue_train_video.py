...
Tiếp tục training từ model video đã có sẵn
"""
...
def prepare_dataset(dataset_root, n_samples=500, mode="random", frame_output_dir="extracted_frames_continue"):
