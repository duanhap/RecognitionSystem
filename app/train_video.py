...
def prepare_dataset(dataset_root, n_samples=500, mode="random", frame_output_dir="extracted_frames", force_extract=False):
    """
...
# ==========================
def video_level_predictions(model, video_paths, true_labels, frame_output_dir="temp_frames_video_eval", max_frames_per_video=50):
    """
...
def run_video_training_pipeline(
    ...
    # 1. Trích xuất frames từ video (giữ lại cho lần sau)
    ...
    # 7b. Evaluation - VIDEO LEVEL (THÊM MỚI)
